...
class Playfield {
    ...
    /**
     * search for a position in the field and return value if possible
     * @param {string} position 
     * @returns {string} or null if position does not exist
     */
    _search(position) {
        return '';
    }
     ...
     * @param {string} position 
     * @returns {string} value on position or null
     */
